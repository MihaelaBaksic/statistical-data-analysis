...
srednja_vrijednost <- matrix(c(mean(female_subjects$neuroticism_score), mean(male_subjects$neuroticism_score),mean(female_subjects$extraversion_score), mean(male_subjects$extraversion_score),mean(female_subjects$agreeable_score), mean(male_subjects$agreeable_score),mean(female_subjects$conscientiousness_score), mean(male_subjects$conscientiousness_score),mean(female_subjects$openness_score), mean(male_subjects$openness_score)),ncol=2)
