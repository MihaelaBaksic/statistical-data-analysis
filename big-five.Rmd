...
varijance <- matrix(
  c(var(female_subjects$neuroticism_score), var(male_subjects$neuroticism_score),
    var(female_subjects$extraversion_score), var(male_subjects$extraversion_score),
    var(female_subjects$agreeable_score), var(male_subjects$agreeable_score),
    var(female_subjects$conscientiousness_score), var(male_subjects$conscientiousness_score),
    var(female_subjects$openness_score), var(male_subjects$openness_score)),ncol=2)
