...
srednja_vrijednost <- matrix(c(
  mean(female_subjects$neuroticism_score),mean(male_subjects$neuroticism_score),
  mean(female_subjects$extraversion_score), mean(male_subjects$extraversion_score),
  mean(female_subjects$agreeable_score), mean(male_subjects$agreeable_score),
  mean(female_subjects$conscientiousness_score), mean(male_subjects$conscientiousness_score),
  mean(female_subjects$openness_score), mean(male_subjects$openness_score)),ncol=2)
colnames(srednja_vrijednost) <- c("Muškarci","Žene")
...
varijance <- matrix(c(var(female_subjects$neuroticism_score), var(male_subjects$neuroticism_score),var(female_subjects$extraversion_score), var(male_subjects$extraversion_score),var(female_subjects$agreeable_score), var(male_subjects$agreeable_score),var(female_subjects$conscientiousness_score), var(male_subjects$conscientiousness_score),var(female_subjects$openness_score)),ncol=2)
colnames(varijance) <- c("Muškarci","Žene")
...
print(varijance)
cat(mean(female_subjects$neuroticism_score), mean(male_subjects$neuroticism_score))
```
