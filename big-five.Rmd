...
model_os = lm(openness_score~age,data=bigfive)

plot(bigfive$age,bigfive$openness_score)
lines(bigfive$openness_score, model_os$fitted.values, col='red')
...
hist(model_os$residuals, breaks = 100)
...
lillie.test(rstandard(model_os))
